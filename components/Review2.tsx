...
const ReviewTwo = ({ text }: ReviewProps) => {
  return (
    <div
      className={`p-8 m-2 bg-white shadow-md sm:w-[660px] h-[266px] rounded-md border border-[#E6E6E6] whitespace-normal ${styles.logosliderOpposite}`}
    >
      <p>{text}</p>
